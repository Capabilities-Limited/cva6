...
#define CUS_BCDfromBin(rs1,rd) .word 0b####000000000000##rs1##000##rd##0101011 // BCDfromBin
#define CUS_BCDADD(rs1,rs2,rd) .word 0b####0000000##rs2####rs1##001##rd##0101011 // BCDADD
